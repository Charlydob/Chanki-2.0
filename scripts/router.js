...
export const createRouter=({root,title,nav,diag,hardReset})=>{const routes={login:'Cardshell',decks:'Mazos',cards:'Tarjetas',study:'Estudiar',explore:'Explorar',stats:'Stats',settings:'Ajustes'};
...
if(r==='decks') renderDecks(root); if(r==='cards') renderCards(root); if(r==='study') renderStudy(root); if(r==='explore') renderExplore(root); if(r==='stats') renderStats(root); if(r==='settings') renderSettings(root,go,diag,hardReset);
};
